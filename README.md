...
I want to be able to add a new record of Poker Tournament results
...
I want to give each Poker Tournament a title and date
...
I want to be able to add a Comment to a Poker Tournament entry

As a user
So that I can see my past big events/big hands
I want to see associated Comments when viewing a Poker Tournament entry
